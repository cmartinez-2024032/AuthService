...
public class UserRepository(ApplicationDbContext context) : IUserRepository
{
    ...
    public async Task<User> GetByPasswordResetTokenAsync(string token)
    {
        var user = await context.Users
            ...
            .FirstOrDefaultAsync(u => u.UserPasswordReset != null &&
                                    ...
                                    u.UserPasswordReset.PasswordResetToken > DateTime.UtcNow);
        return user ?? throw new InvalidOperationException("User not found or token expired.");
    }
    ...
    public Task<User?> GetByUserAsync(string email)
    {
        throw new NotImplementedException();
    }

    public Task<User?> GetByEmailVerofocationTokenAsync(string token)
    {
        throw new NotImplementedException();
    }

    public Task<bool> ExistByUsernameAsync(string username)
    {
        throw new NotImplementedException();
    }
}+